-- ============================================================
-- Database Schema: Aplikasi Manajemen Rapat
-- ============================================================
...
-- Migration: run if table already exists (skip for fresh install)
...
CREATE TRIGGER update_minutes_updated_at BEFORE UPDATE ON meeting_minutes
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
